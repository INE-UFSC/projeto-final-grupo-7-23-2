...
class LevelSelectUI(UI):
    def __init__(self, context) -> None:
        ...
        self.buttons = [ 
            ...
            TextButton(pygame.font.Font('assets/fonts/Pixeltype.ttf',42).render(' Retornar',True,'black'),'red',pygame.Rect(600,650,125,35),lambda: context.change_state(menu_state.MenuState(context)))
        ]
